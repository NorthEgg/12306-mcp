...
export interface LeftTicketsQueryResponse extends QueryResponse {
  httpstatus: string;
  data: {
    [key: string]: any;
  };
...
export interface InterlineQueryResponse extends QueryResponse {
  data:
    | {
        flag: boolean;
        result_index: number;
...
export interface TrainSearchResponse extends QueryResponse {
...
export interface RouteQueryResponse extends QueryResponse {
  httpstatus: string;
  data: {
