...
const CITY_STATIONS: Record<string, { station_code: string; station_name: string }[]> = (() => {
...
const CITY_CODES: Record<string, { station_code: string; station_name: string }> = (() => {
  const result: Record<string, { station_code: string; station_name: string }> = {};
...
const NAME_STATIONS: Record<string, { station_code: string; station_name: string }> = (() => {
  const result: Record<string, { station_code: string; station_name: string }> = {};
  for (const station of Object.values(STATIONS)) {
...
function parseInterlinesTicketInfo(interlineTicketsData: InterlineTicketData[]) {
  const result: TicketInfo[] = [];
